...
namespace CaseMngmt.Service.Invoices
{
    public interface IInvoiceService
    {
        ...
        Task<PagedResult<InvoiceViewModel>?> GetAllInvoicesAsync(Guid companyId, Guid? customerId, string? status, DateTime? issueDateFrom, DateTime? issueDateTo, int pageSize, int pageNumber);
